...
@Component({
  selector: 'app-prices',
  template: '<div class="prices-stub">Ceník</div>',
  standalone: false
})
...
describe('HomeComponent', () => {
  ...
  it('renders Ceník, Region, Novinky, Foto, Recepty and Kontakt in the expected order', async () => {
    ...
    expect(element.querySelector('.intro-eyebrow')?.textContent?.trim()).toBe(home.title);
    expect(element.querySelector('.intro-copy')?.textContent).toContain(
